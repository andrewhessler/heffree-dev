...
-->
# Done with dbrs
I'm moving on from latest main project. I was going to make a DB Client in preparation for the retirement of Azure Data Studio.
...
I didn't really understand managing state with it and I'm just much more comfortable with the server/client relationship.
...
Basically looked like kindergarten ADS. Then I wanted to be able to use Vim motions in the input, but all I could really find was 
...
it's not something real I can make.

I'm willing to put in the time, but it's important to me that I see long-term value in it for myself and ideally others.
...
## What next
I'm super happy I got some exposure to Tauri. I hope I get to use it again soon. I really want to make something useful and I want it to be somewhat technical.
...
So that's that, some small toy projects and a KVM is my future at the moment, we'll see how it goes!
